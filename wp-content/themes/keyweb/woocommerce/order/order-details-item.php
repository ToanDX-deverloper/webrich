...
<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order ) ); ?>">
	<td class="hinh-anh">
		<img src="<?php echo wp_get_attachment_url( $product->get_image_id() ); ?>" class="custom-image-thankyou" />
	...
	<td class="woocommerce-table__product-name product-name order-td-thankyou">
		<?php
		// $get_anh=$product-> get_image();
		// echo $get_anh;
